  ...
  <div>
    <nav class="navbar is-dark">
      <div class="navbar-start">
        ...
        <div class="navbar-item has-dropdown is-hoverable">
          ...
          <div class="navbar-dropdown">
            ...
            <div class="navbar-item">
              <router-link to="/farma">Farma</router-link>
            </div>
            <div class="navbar-item">
      ...
      <div class="navbar-item">
        ...
        <option value="Janeiro 2021" >Janeiro</option>
        <option value="Fevereiro 2021" >Fevereiro</option>
        <option value="Março 2021" >Março</option>
        <option value="Abril 2021" >Abril</option>
        <option value="Maio 2021" >Maio</option>
        <option value="Junho 2021" selected>Junho</option>
        <option value="Julho 2021" >Julho</option>
        <option value="Agosto 2021" >Agosto</option>
        <option value="Setembro 2021" >Setembro</option>
        <option value="Outubro 2021" >Outubro</option>
        <option value="Novembro 2021" >Novembro</option>
        <option value="Dezembro 2021" >Dezembro</option>
        </select>
        </div>
      </div>
